...
def send_mail():
    ...
    测试报告请下载好后查看
    '''
    if ApiAgentUrl == 'http://api.xfj100.com/api/mobile':
        to = ['45324214@qq.com', '23071059@qq.com', '34414822@qq.com', 'chenxiaomumu@163.com', '736297001@qq.com']
    elif ApiAgentUrl == 'http://api.ykb100.com/api/mobile':
...
if __name__ == '__main__':
    sys.path.append(r'D:\\PycharmProjects\\XFJ\\XmApi\\')
    ...
    description = '环境：' + ApiXmUrl + '\n' + '用例执行情况'
    with open(report_name, "wb") as f:
        runner = HTMLTestRunner(stream=f, title='幸福小秘接口测试报告', description=description)
        runner.run(all_case)
        f.close()
